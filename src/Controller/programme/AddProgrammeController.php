            ...
            if (false === $this->authorizationChecker->isGranted('ROLE_ADMIN')) {
                ...
                if ($form->isSubmitted() && $form->isValid()) {
                    ...
                    if ($programmeExistant != null) {
                        $this->addFlash('error', 'Un programme ayant le même libellé ' . $programmeExistant->getLibelleActivite() . ' existe déjà.',
                        );
                        return $this->redirectToRoute('app_programme_new', array('id' => $activite->getId()));
                    }
...
//                    }
                    ...
                    //Mouchard
                    $this->saveMouchard("programme", $activite->getId(), $activite->getLibelleActivite(),
