...
#[Route('/tache')]
class EditTacheController extends AbstractController
{
                ...
                if ($form->isSubmitted() && $form->isValid()) {
                    ...
                    if ($axeExistant != null) {
                        if ($activite->getId() != $axeExistant->getId()) {
                            $this->addFlash('error', 'Une tache ayant le même libelle ' . $axeExistant->getLibelleActivite() . ' existe déjà.',
                            );
                            return $this->redirectToRoute('app_action_edit', array('id' => $activite->getId()));
                        }
                    }
                    ...
                    return $this->redirectToRoute('app_tache_show', ['id'=>$activite->getId()], Response::HTTP_SEE_OTHER);
                }
