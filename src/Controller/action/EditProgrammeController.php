                ...
                if ($form->isSubmitted() && $form->isValid()) {
                    ...
                    if ($axeExistant != null) {
                        if ($activite->getId() != $axeExistant->getId()) {
                            $this->addFlash('error', 'Une action ayant le même libelle ' . $axeExistant->getLibelleActivite() . ' existe déjà.',
                            );
                    ...
                    return $this->redirectToRoute('app_action_show', ['id'=>$activite->getId()], Response::HTTP_SEE_OTHER);
                }
