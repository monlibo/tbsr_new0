...
use App\Form\CategorieDocument1Type;
...
class GetListCategorieDocumentController extends AbstractController
{
        ...
        if (false === $this->authorizationChecker->isGranted('IS_AUTHENTICATED_FULLY')) {
            ...
            if (false === $this->authorizationChecker->isGranted('ROLE_ADMIN')) {
                ...
                return $this->render('categorie_document/index.html.twig', [
                    'categorieDocuments' => $categorieDocumentRepository->findBy(array('supprimer'=>false))]);
            } else {
