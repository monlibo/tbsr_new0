...
#[Route('/axe')]
class EditAxeController extends AbstractController
{
    ...
    #[Route('/{id}/edit', name: 'app_axe_edit', methods: ['GET', 'POST'])]
                ...
                if ($form->isSubmitted() && $form->isValid()) {
                    ...
                    if ($axeExistant != null) {
                        if ($activite->getId() != $axeExistant->getId()) {
                            $this->addFlash('error', 'Un axe ayant le même libelle ' . $axeExistant->getLibelleActivite() . ' existe déjà.',
                            );
                            return $this->redirectToRoute('app_axe_edit', array('id' => $activite->getId()));
                        }
                    }
                    ...
                    return $this->redirectToRoute('app_axe_show', ['id'=>$activite->getId()], Response::HTTP_SEE_OTHER);
                }
