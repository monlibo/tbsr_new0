 ...
 */
final class Version20231104223231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD identifiant_agent BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agent DROP structure_id, DROP fonction_id, CHANGE identifiant_agent identifiant_agent VARCHAR(50) NOT NULL');
