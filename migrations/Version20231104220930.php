 ...
 */
final class Version20231104220930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D649D139F311 ON user');
        $this->addSql('ALTER TABLE user DROP identifiant_agent');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD identifiant_agent VARCHAR(33) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649D139F311 FOREIGN KEY (identifiant_agent) REFERENCES agent (identifiant_agent) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649D139F311 ON user (identifiant_agent)');
    }
}
