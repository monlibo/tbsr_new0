 ...
 */
final class Version20231104221535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `primary` ON agent');
        $this->addSql('ALTER TABLE agent ADD pk_agent BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', ADD structure_id INT NOT NULL, ADD fonction_id INT NOT NULL, CHANGE identifiant_agent identifiant_agent VARCHAR(255) NOT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_268B9C9D5DB28744 ON agent (pk_agent)');
        ...
        $this->addSql('ALTER TABLE agent ADD PRIMARY KEY (identifiant_agent, pk_agent)');
        $this->addSql('ALTER TABLE user CHANGE identifiant_agent identifiant_agent VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_268B9C9D5DB28744 ON agent');
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON agent');
        $this->addSql('ALTER TABLE agent DROP pk_agent, DROP structure_id, DROP fonction_id, CHANGE identifiant_agent identifiant_agent VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE agent ADD PRIMARY KEY (identifiant_agent)');
        $this->addSql('ALTER TABLE user CHANGE identifiant_agent identifiant_agent VARCHAR(50) DEFAULT NULL');
    }
}
