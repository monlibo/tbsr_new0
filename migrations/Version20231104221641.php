 ...
 */
final class Version20231104221641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agent ADD structure_id INT NOT NULL, ADD fonction_id INT NOT NULL, ADD pk_agent BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', CHANGE identifiant_agent identifiant_agent VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agent DROP structure_id, DROP fonction_id, DROP pk_agent, CHANGE identifiant_agent identifiant_agent VARCHAR(50) NOT NULL');
